...
| |Day1|Day2|Day3|Day4|
|:----|:----|:----|:----|:----|
|午前|環境構築</BR>モジュール1|モジュール2|モジュール4|モジュール6|
|午後|モジュール1</BR>自己学習（LABなど）|モジュール3</BR>自己学習（LABなど） |モジュール5</BR>自己学習（LABなど）|モジュール6</BR>自己学習（LABなど）|
...
- ラボ2-タスク5-4
  - 上部のナビゲーション リボンから [優先順位の再設定] を選択し、[先頭に移動(優先度が最も高い) ] を選択します。